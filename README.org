...
+ Upgrade ~persist.el~ dependency to ~0.8~ to fix data loss issue which occurred when ~activities.el~ was reloaded in a running Emacs session (See [[https://github.com/alphapapa/activities.el/issues/109][#109]].)
