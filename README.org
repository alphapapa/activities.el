...
*Additions*
+ Offer current ~project~ name by default for new activities.  (Thanks to [[https://github.com/josephmturner][Joseph Turner]].)
+ Use current activity as default for various completions.  (Thanks to [[https://github.com/josephmturner][Joseph Turner]].)
